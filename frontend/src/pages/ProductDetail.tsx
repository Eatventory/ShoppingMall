    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/products" className="text-mint-600 hover:underline">
            상품 목록으로 돌아가기
          </Link>
        </div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span>{isInWishlist(product.id) ? '찜한 상품' : '찜하기'}</span>
              </button>
              ...
              <Link
                to="/checkout"
                className="w-full flex items-center justify-center py-3 px-6 bg-[#14213d] text-white rounded-lg hover:bg-[#1a2540] transition-colors font-semibold"
              >
                바로 구매
              </Link>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">장바구니에 추가되었습니다</h3>
              ...
              <div className="flex space-x-3">
                ...
                <Link
                  to="/cart"
                  className="flex-1 px-4 py-2 bg-[#14213d] text-white rounded-md text-sm font-medium hover:bg-[#1a2540]"
                >
                  장바구니 보기
                </Link>
              </div>
